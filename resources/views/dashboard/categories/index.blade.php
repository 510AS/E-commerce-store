                                            ...
                                            @isset($main_cat)
                                                @foreach($main_cat as $category)
                                                    <tr>
                                                        ...
                                                        <td> <img style="width: 150px; height: 100px;" src="{{ asset('assets/images/category/'. $category->picture) }}"></td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.maincategories.edit',$category -> id)}}"
                                                                   ...
                                                                   <a class="btn btn-outline-info btn-min-width box-shadow-3 mr-1 mb-1" href="{{route('admin.maincategories.show',$category -> id)}}">Show</a>
